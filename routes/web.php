...
Route::get('/product-page', [FrontendController::class, 'productPage'])->name('product.page');
...
Route::get('career/{id}', [FrontendController::class, 'show'])->name('careerDetails.show');

Route::get('/top-management', [FrontendController::class, 'topManagement'])->name('topManagement');
Route::get('/company-profile', [FrontendController::class, 'companyProfile'])->name('companyProfile');
...
Route::post('/contact/submit', [ContactController::class, 'contactForm'])->name('contactForm.page');
