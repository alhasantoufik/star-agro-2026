...
Route::prefix('admin')
    ...
    ->group(function () {
        ...
        Route::prefix('home-page')->group(function () {
            ...
            Route::post('csr/update', [CsrController::class, 'update'])->name('csr.update');
        ...
        */
        ...
        Route::get('job-apply', [JobApplyController::class, 'index'])->name('job_apply.index');
        Route::post('job-apply', [JobApplyController::class, 'store'])->name('job_apply.store');
        Route::get('job-apply/{jobApply}', [JobApplyController::class, 'show'])->name('job_apply.show');

        Route::get('job-apply/{jobApply}/edit', [JobApplyController::class, 'edit'])->name('job_apply.edit');
        Route::put('job-apply/{jobApply}', [JobApplyController::class, 'update'])->name('job_apply.update');

        Route::delete('job-apply/{jobApply}', [JobApplyController::class, 'destroy'])->name('job_apply.destroy');
    });
