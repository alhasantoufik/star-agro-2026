...
@section('title', 'All Job Application')
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 mt-4">
            <div class="card">
                <div class="card-header">
                    <h4 class="text-uppercase"> All Job Application </h4>
                </div>
                <div class="body">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($jobApplication->resume)
                                        <a href="{{ asset($jobApplication->resume) }}" target="_blank" class="btn btn-sm btn-primary" download>
                                            Download Resume
                                        </a>
                                    @else
                                ...
                                <td>
                                    @auth
                                        @if(auth()->user()->system_admin === 'Admin')
                                            <form class="d-inline-block" action="{{ route('job_apply.destroy', $jobApplication->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
