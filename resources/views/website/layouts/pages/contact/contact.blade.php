	...
	<section id="or-breadcrumbs" class="or-breadcrumbs-section position-relative" data-background="assets/img/bg/bg-page-title.jpg">
		...
		<div class="container">
			<div class="or-breadcrumbs-content text-center">
				<div class="page-title headline"><h1>Contact</h1></div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="or-contact-innerbox headline or-contact-innerbox-layout1">
						<div class="item--inner bg-image">
							...
							<div class="item--description">{{ $website_setting->address }}</div>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-6">
					<div class="or-contact-innerbox headline or-contact-innerbox-layout1">
						<div class="item--inner bg-image">
							...
							<div class="item--description">{{ $website_setting->phone }}</div>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-6">
					<div class="or-contact-innerbox headline or-contact-innerbox-layout1">
						<div class="item--inner bg-image">
							...
							<div class="item--description">{{ $website_setting->email }}</div>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="or-contact-form-wrapper">
				...
				<div class="or-contact-form-content">
					<form action="{{ route('contactForm.page') }}" method="post" enctype="multipart/form-data">
                        @csrf
						<div class="row">
							<div class="col-md-6">
